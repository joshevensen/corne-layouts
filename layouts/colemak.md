...
Source of truth for `dist/colemak.vil` — edit the grids and the Settings table below, then run `npm run build` to produce it. Run `npm run format` first if you've hand-edited this file and the columns have drifted out of alignment.
