...
Source of truth for `dist/dvorak.vil` — edit the sections below, then run `npm run build` to produce it. Run `npm run format` first if you've hand-edited this file and columns have drifted out of alignment.
